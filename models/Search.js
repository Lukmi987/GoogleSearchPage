...
export default class Search {
    constructor(query){
        // this query parame is the one that we need to specify whenever we create a new object based on Search class
        this.query = query;
    }

    /**
     * Using Google Custom Search Api to search for input query and return json data
     * json() method returns a promise that resolves with the result of parsing the body text as JSON
